<?php
	...
	$schema = array(   
		'trans_mrs2016' => array(   
			'transaction_id' => array('appgini' => 'SMALLINT(5) not null primary key auto_increment '),
			'firstname' => array('appgini' => 'VARCHAR(50) '),
			'lastname' => array('appgini' => 'VARCHAR(50) '),
			'email' => array('appgini' => 'VARCHAR(50) '),
			'phone' => array('appgini' => 'VARCHAR(20) '),
			'quantity' => array('appgini' => 'SMALLINT(4) '),
			'amount' => array('appgini' => 'DOUBLE(6,2) '),
			'mailinglist' => array('appgini' => 'TINYINT(1) default \'1\' '),
			'remarks' => array('appgini' => 'TEXT '),
			'transactiondate' => array('appgini' => 'DATE '),
			'seller' => array('appgini' => 'VARCHAR(40) '),
			'editingdate' => array('appgini' => 'DATE '),
			'editor' => array('appgini' => 'VARCHAR(40) ')
		),
		'duck_mrs2016' => array(   
			'duck_id' => array('appgini' => 'SMALLINT(5) not null primary key auto_increment '),
			'transaction_id' => array('appgini' => 'SMALLINT(5) '),
			'creationdate' => array('appgini' => 'VARCHAR(40) ')
		)
	);

<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'duck_mrs2016' table. 
	...
	*/
	...
	function duck_mrs2016_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function duck_mrs2016_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function duck_mrs2016_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function duck_mrs2016_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['transaction_id'], $data['creationdate']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['duck_id'], $data['transaction_id']
	...
	*/
	...
	function duck_mrs2016_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['duck_id'], $data['transaction_id'], $data['creationdate']
	...
	*/
	...
	function duck_mrs2016_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function duck_mrs2016_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function duck_mrs2016_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function duck_mrs2016_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function duck_mrs2016_batch_actions(&$args){
